...
public class RecruitDao extends DAO {
	...
	private final String RECURUITDETAILSELECT = "SELECT C.IMG, C.NAME, FINDCODENAME(C.ITEM) ITEM, C.EMPS, FINDCODENAME(C.TYPE) TYPE, C.PROFIT, C.LINK"
					+ " ,R.QUALIFY, R.TITLE, FINDCODENAME(R.EMP_TYPE) EMP_TYPE, FINDLOCNAME(R.LOC) LOC, FINDCODENAME(R.WORK) WORK, "
