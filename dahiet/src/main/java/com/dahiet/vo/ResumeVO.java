...
public class ResumeVO {
   ...
   public String getCa_sub_seq() {
      return ca_sub_seq;
   }
   public void setCa_sub_seq(String ca_sub_seq) {
      this.ca_sub_seq = ca_sub_seq;
   }
   ...
   public String getLic_sub_seq() {
      return lic_sub_seq;
   }
   public void setLic_sub_seq(String lic_sub_seq) {
      this.lic_sub_seq = lic_sub_seq;
   }
   ...
   public String getAct_sub_seq() {
      return act_sub_seq;
   }
   public void setAct_sub_seq(String act_sub_seq) {
      this.act_sub_seq = act_sub_seq;
   }
   ...
   public String getAwd_sub_seq() {
      return awd_sub_seq;
   }
   public void setAwd_sub_seq(String awd_sub_seq) {
      this.awd_sub_seq = awd_sub_seq;
   }
   ...
   public String getLag_sub_seq() {
      return lag_sub_seq;
   }
   public void setLag_sub_seq(String lag_sub_seq) {
      this.lag_sub_seq = lag_sub_seq;
   }
