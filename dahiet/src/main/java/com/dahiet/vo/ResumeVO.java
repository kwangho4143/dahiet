...
public class ResumeVO {
	...
	public String getLic_place() {
		return lic_place;
	}
	public void setLic_place(String lic_place) {
	...
	public Date getLag_date() {
		return lag_date;
	}
	public void setLag_date(Date lag_date) {
