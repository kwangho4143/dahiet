...
<body>
	<div align="center">
		...
		<div>
			<div id="resumeTbl">
				<form id="resumeFrm" name="resumeFrm"
					action="${pageContext.request.contextPath}/resumeInsert.do"
					method="post">

					<div>
						<table>
							<tr
								style="border-top: 5px solid lightgrey; border-bottom: 5px solid lightgrey;">
								<td height="70" colspan="5"><h3 align="center">기 본 정 보</h3></td>
							</tr>
							<tr height="50">
								<th width="150">이력서 제목<span class="point">&nbsp;&nbsp;&nbsp;*</span></th>
								<td colspan="4"><input type="text" id="resume_name"
									name="resume_name" size="80"></td>
							</tr>
							<c:forEach items="${list}" var="vo">
								<tr height="50">
									<td rowspan="3"><img alt="사진"
