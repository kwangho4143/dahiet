...
select.selectpicker {-webkit-tap-highlight-color: rgba(0,0,0,0);
...
<body>
	<div class="container">
		<div class="d-flex justify-content-between align-items-center">
			<h2>채용 공고 상세 페이지</h2>
			<p>
			<form style="width: 500px" action="${pageContext.request.contextPath}/resumeApply.do">
			<button type="button" onclick="location.href ='${pageContext.request.contextPath}/SearchAction.do'" class="btn btn-sm btn-danger">공고목록</button>
