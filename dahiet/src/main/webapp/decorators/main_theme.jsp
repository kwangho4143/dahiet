		...
		<div class="container d-flex align-items-center">
						...
						<c:if test="${sessionScope.major ne null}">
							<li><a
								href="${pageContext.request.contextPath}/ResumeList.do">이력서
									관리</a></li>
						</c:if> <c:if test="${sessionScope.link ne null}">
							<li><a
			...
			<div>
				<c:if test="${sessionScope.id eq null}">
					<a href="${pageContext.request.contextPath}/jsp/user/loginForm.jsp"><img
						style="width: 3.5cm" alt="login"
						src="${pageContext.request.contextPath}/images/login.png"></a>
				</c:if>
				<c:if test="${sessionScope.birth ne null}">
					<a style="padding-left: 20px"
						href="${pageContext.request.contextPath}/UserMypage.do"><img
						style="width: 1cm" alt="mypage"
						src="${pageContext.request.contextPath}/images/mypage.png"></a>
				</c:if>
				<c:if test="${sessionScope.no ne null}">
					<a href="${pageContext.request.contextPath}/companyMypage.do"><img
						style="width: 1cm" alt="mypage"
						src="${pageContext.request.contextPath}/images/mypage.png"></a>
				</c:if>
				<c:if test="${sessionScope.id ne null}">
					<a style="margin-left: 15px"
						...
						style="width: 0.9cm" alt="logout"
						src="${pageContext.request.contextPath}/images/logout.png"></a>
				</c:if>
			</div>
					...
					<div class="columnright">
						<ul>
							...
							<a href="${pageContext.request.contextPath}/Event.do">
								<img src="${pageContext.request.contextPath}/images/QNA.jpg" width="170px">
								</a>
							</li>
						</ul>
						<ul>
							<li>
								<a href="https://www.moel.go.kr/miniWageMain.do" target="_blank">
									<img src="${pageContext.request.contextPath}/images/최저시급.JPG" width="170px">
								</a>
							</li>
						</ul>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 footer-links">
						...
						<ul>
							<li><i class="bx bx-chevron-right"></i> <a
								href="${pageContext.request.contextPath}/jsp/user/loginForm.jsp">로그인</a></li>
							<li><i class="bx bx-chevron-right"></i> <a
								href="${pageContext.request.contextPath}/jsp/user/loginForm.jsp">회원가입</a></li>
							<li><i class="bx bx-chevron-right"></i> <a
								href="${pageContext.request.contextPath}/SearchAction.do">채용정보</a></li>
							<li><i class="bx bx-chevron-right"></i> <a
								href="${pageContext.request.contextPath}/ReviewAction.do">취업토크</a></li>
							<li><i class="bx bx-chevron-right"></i> <a
								href="${pageContext.request.contextPath}/Event.do">고객센터</a></li>
						</ul>
					</div>
